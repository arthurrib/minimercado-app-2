...
export class ContaComponent implements OnInit {
  ...
  informarPagamento(conta: IConta) {
    conta.status = 'PAGO';
    this.contaService.update(conta).subscribe((res: HttpResponse<IConta>) => this.load());
  }
}
