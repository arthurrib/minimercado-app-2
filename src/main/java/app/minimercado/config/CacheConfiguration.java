package app.minimercado.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, app.minimercado.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, app.minimercado.repository.UserRepository.USERS_BY_EMAIL_CACHE);
